...
public abstract class AbstractPostgresMvcTest {
    ...
    Если сгенерируем 19 постов для тестов класса SearchPosts, то получим:
        ...
        4   title: Название 4-ой публикации   text: Контент 4-ой публикации   tags: [пост_4, заметка]
        ...
        8   title: Название 8-ой публикации   text: Контент 8-ой публикации   tags: [пост_8, заметка]
        ...
        12  title: Название 12-ой публикации  text: Контент 12-ой публикации  tags: [пост_12, заметка, лонгрид]
        ...
        16  title: Название 16-ой публикации  text: Контент 16-ой публикации  tags: [пост_16, заметка]
